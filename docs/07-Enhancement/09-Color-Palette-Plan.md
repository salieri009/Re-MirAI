...
| **Anchor / Accent** | `#697fac` | Trust-building accent for typography, badges, borders |
...
- Map existing primary variables to the palette:
  ...
  - Introduce `--color-accent` → `#697fac` for typography + outlines
...
| Login (`02-Login-Page-Enhancement.md`) | Auth card outline + trust badges use `#697fac`; canvas wash `#e6ebf8`. | Ensure contrast ratios ≥ 4.5:1 for badge text. |
...
- ✅ Accent `#697fac` is used consistently for supporting labels, trust signals, and outlines.
