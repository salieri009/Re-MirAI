...
## 1. Overview
The Ritual System is the core data collection mechanism of Re:MirAI. It allows users to create personalized surveys ("Rituals") and share them with friends to collect anonymous feedback, which serves as the foundation for Persona synthesis.
...
| :--- | :--- | :--- |
| **FR-001.1** | The system MUST generate a unique, shareable URL for each Ritual. | P0 |
...
| **FR-001.4** | The system MUST enforce a minimum threshold of 3 responses before unlocking Persona summoning. | P0 |
...
| **NFR-001.2** | **Performance:** Ritual link generation MUST complete within 1 second. | < 1s |
