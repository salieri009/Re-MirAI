...
export const ritualService = {
    ...
    async submitRitualResponse(ritualId, answers) {
        if (USE_MOCK_DATA) {
            await new Promise((resolve) => setTimeout(resolve, 500));
            return {
...
export const personaService = {
    async summonPersona(_mode, _archetypeFilter) {
        if (USE_MOCK_DATA) {
            await new Promise((resolve) => setTimeout(resolve, 500));
            return {
...
export const socialService = {
    async getPublicProfile(_userId) {
        if (USE_MOCK_DATA) {
            await new Promise((resolve) => setTimeout(resolve, 300));
            return mockData.mockPersona;
        }
    ...
    async getCompatibility(_otherUserId) {
        if (USE_MOCK_DATA) {
            await new Promise((resolve) => setTimeout(resolve, 500));
            return {
                chemistryScore: 95,
